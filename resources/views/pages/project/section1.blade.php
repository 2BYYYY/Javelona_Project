        ...
        <div class="col-12">
            <div class="row">
                <div class="col-lg-6 col-12">
                    ...
                    <img class="border border-success border-4 responsive-img-cover project-section1-img" src="{{ asset('images/'.$pt->slug.'.png') }}" alt="{{ $pt->project_name }} picture"/>
                </div>
                <div class="col-lg-6 col-12 mt-lg-0 mt-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ $pt->github }}" target="_blank">
                            <img class="project-section1-img-github" src="{{ asset('images/GithubLogo.png') }}" alt="github button"/>
                        </a>
                    ...
                    <h4 class="medium-text-lg medium-text">{{ $pt->description }}</h4>
                </div>
            </div>
        </div>
    @endforeach
